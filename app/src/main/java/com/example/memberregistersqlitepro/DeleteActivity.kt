...
class DeleteActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnDelete2.setOnClickListener {
            ...
            val db  = DBHelper(applicationContext,  MainActivity.DB_NAME, MainActivity.VERION)
            ...
            if(id.isEmpty()){
                ...
                if(db.deleteTBL(id)){
                    Toast.makeText(this,"ID정보 삭제 성공", Toast.LENGTH_SHORT).show()
                }else{
                    Toast.makeText(this,"ID정보 삭제 실패", Toast.LENGTH_SHORT).show()
                }
            }
        }
